...
class Server(object):
    ...
    def setup(self, **init_kwargs):
        ...
        _, test_dataset = create_datasets_global(
            self.data_path,
            self.dataset_name,
            self.num_clients,
            self.num_shards,
    ...
    def average_model(self, sampled_client_indices, coefficients):
        ...
        raise NotImplementedError  # This implementation is outdated. Need to be updated.
